...
Completed: browser copy/paste/save/close/reopen using the full specimen, with byte-identical saved TXT and exact reopened text; Soft Bold preserved text. Completed focused six-page semantic review and lesson skip-link/font-selector keyboard checks. Evidence and remaining limits: docs/writing-demo/verification.md and docs/accessibility-review.md. Physical devices and actual screen readers remain unverified.
